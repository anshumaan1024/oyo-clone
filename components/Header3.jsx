...
const Header3 = () => {
  return (
    <div className="bg-gradient-to-r from-red-600 to-red-400 h-60" >
      <div className="p-5" >
        <h2 className="text-4xl text-center font-bold text-white" >Over 1,57,000 hotels and homes across 35 countries</h2>
        ...
        <div className="flex mx-20 my-5 font-bold">
          ...
          <button type="submit" className="h-16 px-3 py-2 border-2 border-white   hover:cursor-pointer text-white mr-5 hover:bg-gray-500 rounded-xl" >Homestay in India hotels</button>
        </div>
      </div>
